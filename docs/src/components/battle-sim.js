...
`;var buttonSharedStyles={ButtonSharedStyles:ButtonSharedStyles};class ArmyAction extends LitElement{static get properties(){return{battle:{type:Object}};}static get styles(){return[SharedStyles,ButtonSharedStyles,css`
        :host {
          display: block;
        }
