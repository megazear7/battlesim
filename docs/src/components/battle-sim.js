...
store.addReducers({app:app$1,battle:battle$1});var store$1={store:store};class SnackBar extends LitElement{static get properties(){return{active:{type:Boolean}};}static get styles(){return[css`
        :host {
          display: block;
          position: fixed;
          top: 100%;
