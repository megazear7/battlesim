...
`;var buttonSharedStyles={ButtonSharedStyles:ButtonSharedStyles};const SharedStyles=css`
  :host {
    display: block;
    box-sizing: border-box;
  }
