define(["exports", "./battle-sim.js"], function (_exports, _battleSim) {
  ...
  _exports.$rulesetsDefault = _exports.$rulesets = void 0;

  function _templateObject6_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <section>\n          <p>No active battle. Go to the war tab and either select a battle or create a new battle.</p>\n        </section>\n      "]);

    _templateObject6_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject6_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  function _templateObject5_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <h6>", ".", " ", "</h5>\n              <p>", "</p>\n            "]);

    _templateObject5_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject5_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  function _templateObject4_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <section>\n            <h4>", " ", "</h3>\n            <p>", "</p>\n            ", "\n          </section>\n        "]);

    _templateObject4_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject4_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  function _templateObject3_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <h5>", " ", "</h5>\n            <p>", "</p>\n          "]);

    _templateObject3_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject3_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  function _templateObject2_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <section>\n          <h3>Scenario Rules</h3>\n          ", "\n        </section>\n        <section>\n          <h3>", "</h3>\n        </section>\n        ", "\n      "]);

    _templateObject2_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject2_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  function _templateObject_b0095fe034ff11e98da2ddcf125ddb9c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject_b0095fe034ff11e98da2ddcf125ddb9c = function _templateObject_b0095fe034ff11e98da2ddcf125ddb9c() {
      return data;
    };
  ...
  _exports.$rulesetsDefault = RULESETS;
  var rulesets = {
    default: RULESETS
  };
  _exports.$rulesets = rulesets;

  var RulesView =
  /*#__PURE__*/
  function (_connect) {
    babelHelpers.inherits(RulesView, _connect);

    function RulesView() {
      babelHelpers.classCallCheck(this, RulesView);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(RulesView).apply(this, arguments));
    }

    babelHelpers.createClass(RulesView, [{
      key: "render",
      value: function render() {
        return (0, _battleSim.html)(_templateObject_b0095fe034ff11e98da2ddcf125ddb9c(), this._hasActiveBattle ? (0, _battleSim.html)(_templateObject2_b0095fe034ff11e98da2ddcf125ddb9c(), (0, _battleSim.repeat)(this._battleRules, function (_ref, index) {
          var heading = _ref.heading,
              text = _ref.text;
          return (0, _battleSim.html)(_templateObject3_b0095fe034ff11e98da2ddcf125ddb9c(), index + 1, heading, text);
        }), this._ruleset.name, (0, _battleSim.repeat)(this._ruleset.sections, function (_ref2, index) {
          var heading = _ref2.heading,
              text = _ref2.text,
              subsections = _ref2.subsections;
          return (0, _battleSim.html)(_templateObject4_b0095fe034ff11e98da2ddcf125ddb9c(), index + 1, heading, text, (0, _battleSim.repeat)(subsections, function (_ref3, subIndex) {
            var heading = _ref3.heading,
                text = _ref3.text;
            return (0, _battleSim.html)(_templateObject5_b0095fe034ff11e98da2ddcf125ddb9c(), index + 1, subIndex + 1, heading, text);
          }));
        })) : (0, _battleSim.html)(_templateObject6_b0095fe034ff11e98da2ddcf125ddb9c()));
      }
    }, {
      key: "stateChanged",
