...
import { MOUNTED_ARMOR_BONUS } from './armor.js';
import {
  FOOT_TROOP,
  CAVALRY_TROOP,
  ARTILLERY_TROOP,
...
export const FRESH_UNION_REGIMENT = {
  ...
  maxAmmo: UNION_REGIMENT_SIZE * 100,
  armor: NO_ARMOR,
...
export const FRESH_UNION_CAVALRY_REGIMENT = {
  ...
  maxAmmo: UNION_CAVALRY_REGIMENT_SIZE * 100,
  armor: MOUNTED_ARMOR_BONUS,
  [MELEE_WEAPON]: SWORD,
  [RANGED_WEAPON]: SPRINGFIELD_RIFLED_MUSKET,
  meleeSkill: 60,
  rangedSkill: 50,
...
export const FRESH_CONFEDERATE_REGIMENT = {
  ...
  maxAmmo: CONFEDERATE_REGIMENT_SIZE * 100,
  armor: NO_ARMOR,
  [MELEE_WEAPON]: BAYONETE,
...
export const FRESH_CONFEDERATE_CAVALRY_REGIMENT = {
  ...
  maxAmmo: CONFEDERATE_CAVALRY_REGIMENT_SIZE * 100,
  armor: MOUNTED_ARMOR_BONUS,
  [MELEE_WEAPON]: SWORD,
  [RANGED_WEAPON]: CONFEDERATE_SMOOTH_BORE,
  meleeSkill: 60,
